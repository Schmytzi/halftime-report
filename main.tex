...
The advent of long-read sequencing technologies such as PacBio \gls{smrt} promises to enable direct sequencing and therefore easier detection of large \glspl{sv}.
Costs are still relatively high but keep going down.
Yields increase.

Both technologies can also be used in combination.
You can e.g. do high-coverage \gls{wgs} with Illumina and low-coverage with PacBio to resolve \glspl{sv}.
