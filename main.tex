...
The main analyses were performed using the \texttt{R} package \textsf{gsmr} version 1.0.8.
We used the \texttt{R} package \textsf{MendelianRandomization} for sensitivity analyses, using the included methods: robust \gls{ivw}, weighted median and MR-Egger.
