...
\section{Methods}
Out base cohort was \gls{nsphs}, a cohort study consisting of approx. 1,000 individuals from two municipalities in northern Sweden.
...
We called \glspl{cnv} using \textsf{CNVnator}.
\chapter{Project IV}
