...
Overall, we found 15 loci on 14 chromosomes to be significantly associated ($p < 5*10^{-8}$) with estradiol levels, of which 13 were specific to males, one (\textit{MCM8}) specific to females and one (\textit{CYP3A7}) shared between both sexes.
...
\section{Discussion}
We performed a \gls{gwas} for dichotomized estradiol levels for males and females in \gls{ukb}; the first of its kind.
...
\textit{CYP3A7} encodes cytochrome P450 3A7, which metabolizes a precursor of both androgens and estrogens: \gls{dhea} \cite{Ohmori1998}.
...
These findings point to CYP3A7 fulfilling different functions for steroid-hormone metabolism in males and females.
