...
Estradiol was measured by two-step competitive analysis.
...
Additionally, we performed sensitivity analyses using Tobit modeling, which allowed us to incorporate quantitative measurements where available.
