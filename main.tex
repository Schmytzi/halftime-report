...
% Subtracting 3 from every citation number so the bibliography starts with 1 (My works should not show up there but increase the counter anyway).
...
]{indel}{indel}{small insertion or deletion}
...
Moreover, the emergence of n\gls{ngs} technology led to an ever-increasing amount of genetic data available to research.
...
\begin{enumerate}[label=\Roman*.]
    % Key:name makes the citation show up with name and does not increase the number.
    \item \fullcite{Schmitz2021} \addtocategory{myworks}{Schmitz2021}
    \item \fullcite{Johansson2021} \textit{submitted for publication} \addtocategory{myworks}{Johansson2021}
...
\begin{table}[]
    ...
    \begin{tabular}{@{}lllll@{}}
        \toprule
                                    ...
                                    & \textbf{\begin{tabular}[c]{@{}l@{}}OR\\ (95\% CI)\end{tabular}} & \textbf{P Value} & \textbf{\begin{tabular}[c]{@{}l@{}}OR\\ (95\% CI)\end{tabular}} & \textbf{P Value} \\ \midrule
        \textbf{Breast Cancer}      & \begin{tabular}[c]{@{}l@{}}1.30\\ (1.07--1.57)\end{tabular}     & 0.0074           & \begin{tabular}[c]{@{}l@{}}1.19\\ (1.03--1.38)\end{tabular}     & 0.018            \\
        ...
        \textbf{Ovarian Cancer}     & \begin{tabular}[c]{@{}l@{}}1.55\\ (0.91--2.65)\end{tabular}     & 0.11             & \begin{tabular}[c]{@{}l@{}}1.20\\ (0.99--1.46)\end{tabular}     & 0.066            \\ \bottomrule
        \end{tabular}
...
Lastly, I would like to thank all my family and friends both in and outside of Uppsala, especially my boyfriend \textit{Leandro}, who might not have contributed directly to my research but made the last two years as amazing as they were.
