...
Most \gls{mr} studies are based on \gls{gwas} summary statistics.
While you could use individual-level data for one-sample studies, most of them are summary-based, too.
