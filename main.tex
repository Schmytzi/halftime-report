...
We selected 15 individuals to be resequenced using PacBio \gls{smrt} sequencing based on five \gls{cnv} that showed strong associations, high polymorphism and included both deletions and duplications.
...
We called \glspl{sv} using three different tools: SVIM v1.4.2, Sniffles v1.0.12 and PBSV v2.4.0.
